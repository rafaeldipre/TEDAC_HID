...
__ALIGN_BEGIN static uint8_t CUSTOM_HID_ReportDesc_HS[USBD_CUSTOM_HID_REPORT_DESC_SIZE] __ALIGN_END =
{
  ...
  // 72 buttons (72 bits = 9 bytes exactly, no padding needed)
...
static const GPIO_TypeDef* btn_port[72] = {
...
static const uint16_t btn_pin[72] = {
...
void JOYSTICK_SendReport(void)
{
  ...
  /* Pack 72 buttons into 9 bytes (72 bits exact, inverted logic: RESET = pressed = 1) */
