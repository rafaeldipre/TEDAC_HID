...
__ALIGN_BEGIN static uint8_t CUSTOM_HID_ReportDesc_HS[USBD_CUSTOM_HID_REPORT_DESC_SIZE] __ALIGN_END =
{
  ...
  // 2-bit padding to align to byte boundary (70 bits + 2 = 9 bytes)
  0x75, 0x01,        //   Report Size (1)
...
static const GPIO_TypeDef* btn_port[70] = {
  ...
  GPIOB, GPIOB, GPIOB, GPIOC, GPIOC, GPIOC, GPIOC, GPIOC,  // BTN 41-48
  GPIOC, GPIOC, GPIOC, GPIOC, GPIOC, GPIOF, GPIOF, GPIOF,  // BTN 49-56
  GPIOF, GPIOF, GPIOF, GPIOF, GPIOG, GPIOG, GPIOG, GPIOG,  // BTN 57-64
  GPIOG, GPIOG, GPIOG, GPIOG, GPIOG, GPIOG                  // BTN 65-70
};

static const uint16_t btn_pin[70] = {
  ...
  GPIO_PIN_5,  GPIO_PIN_6,  GPIO_PIN_7,  GPIO_PIN_8,   // BTN 45-48 (PC5-PC8)
  GPIO_PIN_9,  GPIO_PIN_10, GPIO_PIN_11, GPIO_PIN_12,  // BTN 49-52 (PC9-PC12)
  ...
  GPIO_PIN_14, GPIO_PIN_15                              // BTN 69-70 (PG14,PG15)
};
...
void JOYSTICK_SendReport(void)
{
  ...
  /* Pack 70 buttons into 9 bytes (70 bits + 2 pad = 72 bits, inverted logic: RESET = pressed = 1) */
  ...
  USBD_CUSTOM_HID_SendReport(&hUsbDeviceHS, report, 21);
}
